...
if __name__ == "__main__":
	...
	es.create_swing_excel("New York", 2012, 2016)
	...
	es.create_margin_mapchart(["Tennessee", "North Carolina", "South Carolina", "Georgia", "Florida", "Alabama", "Mississippi", "Arkansas", "Texas"])
